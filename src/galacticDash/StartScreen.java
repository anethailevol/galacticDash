...
public class StartScreen extends JPanel{
	...
	public StartScreen(GameWindow window) {
		...
		//button sizes
		playButton.setPreferredSize(new Dimension(280, 100));
		playButton.setMaximumSize(new Dimension(280, 100));
		
		levelsButton.setPreferredSize(new Dimension(280, 100));
		levelsButton.setMaximumSize(new Dimension(280, 100));

		helpButton.setPreferredSize(new Dimension(280, 100));
		helpButton.setMaximumSize(new Dimension(280, 100));
		...
		levelsButton.setBackground(Color.BLACK);
		...
		levelsButton.addActionListener(e -> window.showScreen("levels"));
